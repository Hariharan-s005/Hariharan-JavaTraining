...
public class ValuePassing {
    ...
    public static void main(String[] args) {
		 ...
		 System.out.println();
		 ValuePassing value=new ValuePassing();
		 System.out.println("Object Before call by reference: "+value.ref);
		 value.objectPassByReference(value);
		 System.out.println("Object After call by reference: "+value.ref);
    ...
    void objectPassByReference(ValuePassing q)
    {
    	q.ref=q.ref+10;
    }
