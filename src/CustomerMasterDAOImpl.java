...
public class CustomerMasterDAOImpl implements CustomerMasterDAO{
	...
	public CustomerMaster get(int id) throws SQLException {
		...
		String query = "SELECT * FROM CUSTOMER_MASTER WHERE item_no = "+id+";";
	...
	public int delete(CustomerMaster customerMaster) throws SQLException {
		...
		Statement stmt = con.createStatement();
		String query = "DELETE FROM CUSTOMER_MASTER WHERE id_no = "+customerMaster.getCustomerId()+";";
		int n = stmt.executeUpdate(query);
	...
	public int update(CustomerMaster customerMaster) throws SQLException {
		...
		Statement stmt = con.createStatement();
		String query = "UPDATE ITEM_MASTER SET item_id = '"+customerMaster.getCustomerId()+"' , customer_name = "+customerMaster.getCustomerName()+", customer_address = "+customerMaster.getCustomerAddress()+";)"; 
		int n = stmt.executeUpdate(query);
