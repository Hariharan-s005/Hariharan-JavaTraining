...
public class InvoiceMasterDAOImpl implements InvoiceMasterDAO{
	...
	public int delete(InvoiceMaster invoiceMaster) throws SQLException {
		...
		String query = "DELETE FROM ITEM_MASTER VALUES("+invoiceMaster.getInvoiceNo()+", ' "+invoiceMaster.getDate()+" ' ,"+invoiceMaster.getCustomerId()+";";
		int n = stmt.executeUpdate(query);
		return n;
	}
	...
	public int update(InvoiceMaster invoiceMaster) throws SQLException {
		...
		Statement stmt = con.createStatement();
		String query = "UPDATE ITEM_MASTER SET item_des = ("+invoiceMaster.getInvoiceNo()+", ' "+invoiceMaster.getDate()+" ' ,"+invoiceMaster.getCustomerId()+";";
		int n = stmt.executeUpdate(query);
