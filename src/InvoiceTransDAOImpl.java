...
public class InvoiceTransDAOImpl implements InvoiceTransDAO{
	...
	public int delete(InvoiceTrans invoiceTrans) throws SQLException {
		...
		String query = "DELETE FROM ITEM_TRANS VALUES("+invoiceTrans.getInvoiceNo()+", ' "+invoiceTrans.getItemNo()+" ' ,"+invoiceTrans.getItemQty()+";";
		int n = stmt.executeUpdate(query);
		return n;
	}
	...
	public int update(InvoiceTrans invoiceTrans) throws SQLException {
		...
		Statement stmt = con.createStatement();
		String query = "UPDATE ITEM_TRANS SET item_des = ("+invoiceTrans.getInvoiceNo()+", ' "+invoiceTrans.getItemNo()+" ' ,"+invoiceTrans.getItemQty()+";";
		int n = stmt.executeUpdate(query);
